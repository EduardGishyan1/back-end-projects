...
@movie_router.post("/")
async def add_new_movie(movie:schemas.Movie,current_user:str = Depends(auth_utils.get_current_user),
    ...
    return {"message": f"Movie successfully added by {current_user}"}
