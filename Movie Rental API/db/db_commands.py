...
CREATE_TABLE_USERS = """
    CREATE TABLE IF NOT EXISTS users (id SERIAL PRIMARY KEY,username VARCHAR(50) UNIQUE,password TEXT,email VARCHAR(50) UNIQUE)
"""
CREATE_TABLE_MOVIES = """
    CREATE TABLE IF NOT EXISTS movies (id SERIAL PRIMARY KEY, title VARCHAR(25),genre VARCHAR(15),rating float)
"""
CREATE_TABLE_RENTALS = """CREATE TABLE IF NOT EXISTS rentals (
...
INSERT_INTO_MOVIES = """
    INSERT INTO movies (title,genre,rating) VALUES ($1,$2,$3) RETURNING (title,genre,rating)
"""
